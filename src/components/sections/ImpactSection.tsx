  ...
  return (
    <section
      style={{
        ...
        backgroundImage: "url('/website/img-operator.jpg')",
      ...
      >
        <div style={{ position: "relative", zIndex: 2, maxWidth: "800px" }}>
          ...
          >
            ...
            <span style={{ display: "block", color: "#14b8a6" }}>
              {t("impact.headline2")}
            </span>
          </h2>
          <p
        ...
        >
          <div
            style={{
              ...
              borderRadius: "48px",
              background:
                "radial-gradient(circle at center, rgba(20,184,166,0.22), transparent 56%)",
              filter: "blur(32px)",
            }}
          />
          {chips.map((chip) => (
          ...
          <div
            style={{
              ...
              padding: "18px",
              background:
                "linear-gradient(180deg, rgba(22,34,36,0.94), rgba(8,16,18,0.96))",
          ...
          >
            <div
              style={{
                ...
                background:
                  "linear-gradient(180deg, rgba(11,23,26,0.98), rgba(11,23,26,0.84))",
                position: "relative",
              }}
            >
              <div
                ...
                >
                  <div
                    style={{
                      ...
                      background:
                        "linear-gradient(180deg, rgba(20,184,166,0.12), rgba(20,184,166,0.03))",
                      display: "grid",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        padding: "18px 16px",
                        background:
                          "linear-gradient(180deg, rgba(12,34,36,0.94), rgba(6,14,15,0.92))",
                        border: "1px solid rgba(20,184,166,0.18)",
                        display: "grid",
                    ...
                    >
                      {["Video wall", "Alarms", "Cameras", "Layouts"].map(
                        (item, index) => (
                          <div
                            key={item}
                            style={{
