...
export function HeroSection() {
  ...
  return (
    ...
    >
      <div
        className="section-shell hero-layout"
      ...
      >
        <div style={{ padding: "28px 0", position: "relative" }}>
          ...
          >
            ...
            <span style={{ display: "block", color: COLORS.green }}>
              {t("hero.headline2")}
            </span>
          </h1>
        ...
        <div className="hero-media-wrap">
          ...
          <div className="hero-floating-bar">
            ...
            <div>
              <div
                style={{ color: "#ffffff", fontWeight: 800, fontSize: "13px" }}
              >
                GroundCTRL
              </div>
              <div
                style={{ color: "rgba(255,255,255,0.58)", fontSize: "11px" }}
              >
                Scenario sync active
              </div>
            </div>
          </div>
